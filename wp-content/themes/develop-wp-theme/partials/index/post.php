                    ...
                    <div class="singles_items ">
                        <div class="edu_cat">
                            <div class="pic">
                                <div class="topic_level bg-info text-white">سطح : متوسط</div>
                                <div class="topic_cat bg-warning text-white">جاوااسکریپت</div>
                                <a class="pic-main" href="single.html" style="background-image:url('<?php echo get_template_directory_uri().'/assets/image/course-2.jpg' ?>');"></a>
                            </div>
                            <div class="edu_data singles_items_border_bottom">
                    ...
                    <div class="singles_items ">
                        <div class="edu_cat">
                            <div class="pic">
                                <div class="topic_level bg-info text-white">سطح : متوسط</div>
                                <div class="topic_cat bg-warning text-white">جاوااسکریپت</div>
                                <a class="pic-main" href="#" style="background-image:url('<?php echo get_template_directory_uri().'/assets/image/course-3.jpg' ?>');"></a>
                            </div>
                            <div class="edu_data singles_items_border_bottom">
                                <h4 class="title"><a href="single.html">پلاگین نویسی وردپرس</a></h4>
                                <ul class="meta d-flex mt-4">
                    ...
                    <div class="singles_items ">
                        <div class="edu_cat">
                            <div class="pic">
                                <div class="topic_level bg-info text-white">سطح : متوسط</div>
                                <div class="topic_cat bg-warning text-white">جاوااسکریپت</div>
                                <a class="pic-main" href="single.html" style="background-image:url('<?php echo get_template_directory_uri().'/assets/image/course-4.jpg'?>');"></a>
                            </div>
                            <div class="edu_data singles_items_border_bottom">
                                <h4 class="title"><a href="#">پلاگین نویسی وردپرس</a></h4>
                                <ul class="meta d-flex mt-4">
                    ...
                    <div class="singles_items ">
                        <div class="edu_cat">
                            <div class="pic">
                                <div class="topic_level bg-info text-white">سطح : متوسط</div>
                                <div class="topic_cat bg-warning text-white">جاوااسکریپت</div>
                                <a class="pic-main" href="single.html" style="background-image:url('<?php echo get_template_directory_uri().'/assets/image/course-5.jpg' ?>');"></a>
                            </div>
                            <div class="edu_data singles_items_border_bottom">
                                <h4 class="title"><a href="#">پلاگین نویسی وردپرس</a></h4>
                                <ul class="meta d-flex mt-4">
                    ...
                    <div class="singles_items ">
                        <div class="edu_cat">
                            <div class="pic">
                                <div class="topic_level bg-info text-white">سطح : متوسط</div>
                                <div class="topic_cat bg-warning text-white">جاوااسکریپت</div>
                                <a class="pic-main" href="#" style="background-image:url('<?php echo get_template_directory_uri().'/assets/image/course-6.jpg' ?>');"></a>
                            </div>
                            <div class="edu_data singles_items_border_bottom">
                                <h4 class="title"><a href="single.html">پلاگین نویسی وردپرس</a></h4>
                                <ul class="meta d-flex mt-4">
